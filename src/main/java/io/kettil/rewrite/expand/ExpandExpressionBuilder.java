...
public class ExpandExpressionBuilder {
    ...
    public static ExpandExpr eval(AclRepo repo, String namespace, String objectId, String relation) {
    ...
    private static class Visitor implements UsersetExprVisitor<ExpandExpr> {
        private final AclRepo repo;

        private NamespaceUsersetExpr namespaceConfig;
        private String objectId;
        private String relation;

        private Visitor(AclRepo repo) {
            this.repo = repo;
        }
        ...
        public ExpandExpr eval(NamespaceUsersetExpr namespaceConfig, String objectId, String relation) {
            this.namespaceConfig = namespaceConfig;
            this.objectId = objectId;
            this.relation = relation;

            return this.visitNamespaceExpr(namespaceConfig);
        }

        @Override
        public ExpandExpr visitNamespaceExpr(NamespaceUsersetExpr expr) {
            UsersetExpr relation = expr.getRelations().get(this.relation);
